...
cap = cv2.VideoCapture('C:/Users/Diana/Documents/GitHub/Stabilizer/activity.mpg')
...
out = cv2.VideoWriter('C:/Users/Diana/Documents/GitHub/Stabilizer/output6.avi',fourcc, frame_rate, (frame_width,frame_height))
...
while(cap.isOpened()):
	...
	try:
		...
		img[0:(int(frame_height/2)-1),] = stab(frame1,old_frame1)
		img[int(frame_height/2):frame_height,] = stab(frame2,old_frame2)
	except:
		break
